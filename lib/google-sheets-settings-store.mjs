...
export const SETTINGS_KEYS = ['storeName', 'currency', 'seoTitle', 'seoDescription', 'disclosure', 'heroTag', 'heroTitle', 'heroHighlight', 'heroText', 'heroCta', 'heroUrl', 'heroImage', 'heroVideo', 'visitorCta', 'description', 'markets'];
...
function defaults() {
  return { storeName: 'Amazonite Store', currency: 'USD', seoTitle: 'Amazonite Store — Discover Better Tech', seoDescription: 'Curated electronics and smart-tech picks before you shop.', disclosure: 'Amazonite Store may earn a commission when you purchase through an affiliate link.', heroTag: 'BEST SELLER 🔥', heroTitle: 'Picun F8 Pro', heroHighlight: 'Immersive sound. Better focus.', heroText: 'Discover selected electronics before shopping and continue to AliExpress through the supplied affiliate destination.', heroCta: 'Shop now →', heroUrl: '#products', heroImage: 'assets/picun-f8-pro-hero.webp', heroVideo: '', visitorCta: '', description: '', markets: '' };
}
