...
export const SETTINGS_KEYS = ['storeName', 'currency', 'seoTitle', 'seoDescription', 'disclosure', 'heroTag', 'heroTitle', 'heroHighlight', 'heroText', 'heroCta', 'heroUrl', 'heroImage', 'heroVideo'];
