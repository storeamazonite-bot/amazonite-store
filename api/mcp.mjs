...
function buildServer() {
  const server = new McpServer(
    ...
    {
      instructions:
        'You are connected to the Amazonite Store AI Team. NOVA is the orchestrator/manager and Claude is a specialist. Use these tools for product research and intelligence. Do not publish products or claim affiliate eligibility unless authoritative affiliate data has been verified.'
    }
  );
